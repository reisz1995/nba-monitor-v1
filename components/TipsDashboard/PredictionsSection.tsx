                ...
                <table className="w-full text-left border-collapse min-w-[800px]">
                    <thead>
                        <tr className="bg-slate-900 text-[10px] font-black text-slate-500 uppercase tracking-widest border-b-2 border-slate-800">
                            <th className="px-3 py-3 border-r border-slate-800/50 w-[30%]">MATCHUP: HOME</th>
                            <th className="px-3 py-3 border-r border-slate-800/50 w-[30%]">MATCHUP: AWAY</th>
                            <th className="px-3 py-3 border-r border-slate-800/50 bg-slate-950/40 text-emerald-500/80 w-[50%]">CORE_PICK</th>
                            ...
                            <th className="px-3 py-3 w-50 border-r border-slate-800/50 text-center text-amber-500 font-black tracking-widest uppercase">HANDICAP_EDGE</th>                        
